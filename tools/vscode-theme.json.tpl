{
    ...
    "colors": {
        ...
        "button.secondaryHoverBackground": "{{ selection }}",
        "button.border": "{{ accent }}20",
        "checkbox.background": "{{ background }}",
        "checkbox.foreground": "{{ foreground }}",
        "checkbox.border": "{{ muted }}",
        "checkbox.selectBackground": "{{ lighter_background }}",
        ...
        "inputOption.hoverBackground": "{{ lighter_background }}",
        ...
        "statusBarItem.prominentHoverBackground": "{{ bright_cyan }}",
        ...
        "extensionButton.prominentHoverBackground": "{{ bright_cyan }}",
        "extensionButton.background": "{{ lighter_background }}",
        "extensionButton.foreground": "{{ foreground }}",
        "extensionButton.hoverBackground": "{{ selection }}",
